...
import RoutePointsCreate from '@/views/Me/RoutePoints/RoutePointsCreate.vue'
	...
	routes: [
		...
		},
		{
			...
			children: [
				...
				{
					path: 'route-lists/:id/route-points/new',
					name: 'RoutePointsCreate',
					component: RoutePointsCreate,
					meta: { requiresAuth: true },
				},
				{
					path: 'employees',
