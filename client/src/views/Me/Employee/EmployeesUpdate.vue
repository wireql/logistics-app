...
const action = () => {
    ...
    updateEmployee(data.value, userId, authStore.token)
        .then((res) => {
            notify({
                title: 'Обновление',
...
onMounted(() => {
    ...
    getEmployee(authStore.token, userId)
        .then((res) => {
            ...
            <div class="col-span-12 sm:col-span-8 xl:col-span-4">
                <div class="flex flex-col gap-6">
                    <InputGroup
                        ...
                        :error="data__errors.last_name[0]"
                        label="Фамилия"
                        placeholder="Иванов"
                    />
                    <InputGroup
                        v-model="data.first_name"
                        :error="data__errors.first_name[0]"
                        label="Имя"
                        placeholder="Иван"
                    />
                    <InputGroup
                        v-model="data.middle_name"
                        :error="data__errors.middle_name[0]"
                        label="Отчество"
                    ...
                    <div class="flex flex-col gap-[5px] w-full">
                        ...
                        <p
                            v-if="data__errors.user_category_id !== null"
                            class="text-red-300 text-xs"
                        >
                            {{ data__errors.user_category_id[0] }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 sm:col-span-8 xl:col-span-4">
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex gap-1">
                        <button
                            v-on:click="copyPass()"
                            class="text-sm bg-dark-999 text-white py-[6px] px-[6px] rounded-[6px] w-auto hover:cursor-pointer"
                        >
                            <div class="flex items-center gap-[10px]">
                        ...
                        <button
                            v-on:click="genPass()"
                            class="text-sm bg-dark-999 text-white py-[6px] px-[6px] rounded-[6px] w-full hover:cursor-pointer flex justify-center"
                        >
                            <div class="flex items-center gap-[10px]">
                                <Gear size="24" />
