    ...
    <div class="mt-6 flex flex-col sm:flex-row sm:items-center justify-between">
        <div>
            ...
            <div class="text-xs flex gap-1 items-center">
                ...
                <div
                    v-if="loading"
                    class="h-[12px] rounded bg-gray-200 w-52 animate-pulse"
                ></div>
                <div>{{ data.id }}</div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-5">
            <div class="col-span-4">
                ...
                <div class="mt-6 flex flex-col gap-3">
                    <div
                        v-if="loading"
                        class="h-[50px] rounded bg-gray-200 w-full animate-pulse"
                    ></div>
                    <div
                        v-else
                        v-for="routePoint in routePoints"
                        :key="routePoint.id"
                        class="p-[15px] rounded-xl border border-gray-300"
                    >
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-1">
                                    <div
                                        class="text-xs underline hover:cursor-pointer"
                                    >
                                        Картошка
                                    </div>
                                </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="p-2 bg-[#E9ECEF] rounded-full hover:cursor-pointer w-max"
                            >
                                <InfoBlock />
                            </div>
                        </div>
            ...
            <div class="col-span-8">
                <div class="flex items-center justify-between">
                    <div class="flex flex-col gap-1">
                        ...
                        <div
                            class="flex items-center gap-[5px] hover:cursor-pointer"
                            v-on:click="copyUuid()"
                        >
                    ...
                    <div
                        class="flex items-center gap-1 px-2 py-1 bg-[#E9ECEF] rounded-sm hover:cursor-pointer"
                        v-on:click="downloadRouteList(data.id)"
                    >
                        <Download />
                ...
                <div class="grid grid-cols-8 gap-5 mt-6">
                    <div class="col-span-5">
                        ...
                        <div
                            class="p-[15px] rounded-xl border border-gray-300 mt-3"
                        >
                            <div class="flex gap-2 items-center">
                                <div class="p-2 bg-[#C1E0FF] w-max rounded-sm">
                                    <Truck />
                                ...
                                <div v-if="loading">
                                    <div
                                        class="h-[12px] rounded bg-gray-200 w-24 animate-pulse"
                                    ></div>
                                    <div
                                        class="h-[12px] rounded bg-gray-200 w-24 animate-pulse mt-2"
                                    ></div>
                                </div>
                                <div v-else>
                                    <div class="text-xs">
                ...
                <div class="mt-6">
                    ...
                    <div
                        class="p-[15px] rounded-xl border border-gray-300 mt-3 flex justify-between"
                    >
                        <div class="flex flex-col gap-1">
                            <div class="text-xs text-gray-400">
                                Загруженность, %
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <div v-else class="text-xs">
                                {{
                                    data.vehicle ? data.vehicle.status.name : ''
                                }}
                            </div>
                        </div>
                    </div>
