<script setup>
    ...
    const vehicles = ref([]);
    const fields = [
        'plan_delivery', 'vehicle_id', 'user_id', 'description'
    ];
            ...
            <div class="col-span-12 sm:col-span-8 xl:col-span-4">
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-[5px] w-full">
                        ...
                        <textarea v-model="data.description" class="text-sm w-full border border-gray-300 focus:border-gray-700 bg-dark-100 py-[6px] px-[9px] rounded-[6px]"></textarea>
                    </div>
                    <div class="flex flex-col gap-[5px] w-full">
